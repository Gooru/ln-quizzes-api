...
frisby.create('Creates a Context and assigns it to an Assignee, then tries to retrieve an assigned Context that ' +
    'does not exist')
    .post(QuizzesApiUrl + '/v1/context', {
        'externalCollectionId': 'b7af52ce-7afc-4301-959c-4342a6f941cb',
        'assignees': [
        ...
        frisby.create('Retrieve Owner Profile')
            ...
            .afterJSON(function (assigneeProfile) {
                frisby.create('Tries to retrieve an assigned Context that does not exist')
                    ...
                    .get(QuizzesApiUrl + '/v1/context/assigned/' + '1fd8b1bc-65de-41ee-849c-9b6f339349c9')
                    .addHeader('profile-id', assigneeProfile.id)
                    .addHeader('client-id', 'quizzes')
                    .inspectRequest()
                    .expectStatus(404)
