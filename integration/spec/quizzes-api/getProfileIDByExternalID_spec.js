...
frisby.create('Test Context creation for one assignee and owner')
    ...
    .inspectJSON()
    .afterJSON(function() {
        frisby.create('Get the internal profile ID created in Quizzes as an owner')
...
frisby.create('Test Context creation for one assignee and owner')
    ...
    .inspectJSON()
    .afterJSON(function() {
        frisby.create('Get the internal profile ID created in Quizzes as an assignee')
...
frisby.create('Get the profile id in Quizzes with a random nonexisting id')
