...
public class ContextController {
    ...
    public ResponseEntity<Context> mapContext(@PathVariable String externalCollectionId,
        ...
        return new ResponseEntity<>(contextResponse.getBody(), contextResponse.getStatusCode());
    }
