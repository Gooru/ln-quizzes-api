...
//            return new ResponseEntity<>(result, HttpStatus.NOT_ACCEPTABLE);
    ...
    public ResponseEntity<ContextGetDTO> getContext(
        ...
        CommonContextGetDTO.ContextDataDTO contextDataDTO = new CommonContextGetDTO.ContextDataDTO();

        ContextGetDTO contextGetDTO = new ContextGetDTO();
        contextGetDTO.setId(contextId);
        contextGetDTO.setCollection(collectionDTO);
        contextGetDTO.setOwner(ownerDTO);
        contextGetDTO.setAssignees(assigneesDTO);
