...
public class ContextProfileRecord extends org.jooq.impl.TableRecordImpl<com.quizzes.api.common.model.tables.records.ContextProfileRecord> implements org.jooq.Record6<java.util.UUID, java.util.UUID, java.util.UUID, java.util.UUID, java.lang.Boolean, java.sql.Timestamp> {

	private static final long serialVersionUID = 1396652700;
	 ...
	 */
	@Override
	public org.jooq.Row6<java.util.UUID, java.util.UUID, java.util.UUID, java.util.UUID, java.lang.Boolean, java.sql.Timestamp> fieldsRow() {
	 ...
	 */
	@Override
	public org.jooq.Row6<java.util.UUID, java.util.UUID, java.util.UUID, java.util.UUID, java.lang.Boolean, java.sql.Timestamp> valuesRow() {
	...
	public org.jooq.Field<java.util.UUID> field1() {
		return com.quizzes.api.common.model.tables.ContextProfile.CONTEXT_PROFILE.ID;
	}
	...
	public org.jooq.Field<java.util.UUID> field2() {
		return com.quizzes.api.common.model.tables.ContextProfile.CONTEXT_PROFILE.CONTEXT_ID;
	}
	...
	public org.jooq.Field<java.util.UUID> field3() {
		return com.quizzes.api.common.model.tables.ContextProfile.CONTEXT_PROFILE.PROFILE_ID;
	}
	...
	public org.jooq.Field<java.util.UUID> field4() {
		return com.quizzes.api.common.model.tables.ContextProfile.CONTEXT_PROFILE.CURRENT_RESOURCE_ID;
	}
	...
	public org.jooq.Field<java.lang.Boolean> field5() {
		return com.quizzes.api.common.model.tables.ContextProfile.CONTEXT_PROFILE.IS_COMPLETE;
	}
	...
	public org.jooq.Field<java.sql.Timestamp> field6() {
		return com.quizzes.api.common.model.tables.ContextProfile.CONTEXT_PROFILE.CREATED_AT;
	}
	 ...
	 */
	@Override
	public ContextProfileRecord values(java.util.UUID value1, java.util.UUID value2, java.util.UUID value3, java.util.UUID value4, java.lang.Boolean value5, java.sql.Timestamp value6) {
		return this;
	}
	...
	public ContextProfileRecord() {
		super(com.quizzes.api.common.model.tables.ContextProfile.CONTEXT_PROFILE);
	}

	/**
	 * Create a detached, initialised ContextProfileRecord
	 */
	public ContextProfileRecord(java.util.UUID id, java.util.UUID contextId, java.util.UUID profileId, java.util.UUID currentResourceId, java.lang.Boolean isComplete, java.sql.Timestamp createdAt) {
		super(com.quizzes.api.common.model.tables.ContextProfile.CONTEXT_PROFILE);
