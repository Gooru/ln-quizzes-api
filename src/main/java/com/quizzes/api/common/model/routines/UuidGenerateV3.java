...
public class UuidGenerateV3 extends org.jooq.impl.AbstractRoutine<java.util.UUID> {
	...
	private static final long serialVersionUID = 1412639577;
	...
	public UuidGenerateV3() {
		super("uuid_generate_v3", com.quizzes.api.common.model.Public.PUBLIC, org.jooq.impl.SQLDataType.UUID);
	...
	public void setNamespace(java.util.UUID value) {
		setValue(com.quizzes.api.common.model.routines.UuidGenerateV3.NAMESPACE, value);
	}
	...
	public void setName_(java.lang.String value) {
		setValue(com.quizzes.api.common.model.routines.UuidGenerateV3.NAME, value);
	}
