...
public class ContextProfileEventRecord extends org.jooq.impl.TableRecordImpl<com.quizzes.api.common.model.tables.records.ContextProfileEventRecord> implements org.jooq.Record5<java.util.UUID, java.util.UUID, java.util.UUID, java.lang.Object, java.sql.Timestamp> {

	private static final long serialVersionUID = -8106071;
	 ...
	 */
	public void setEventData(java.lang.Object value) {
		setValue(3, value);
	}
	 ...
	 */
	@Override
	public org.jooq.Row5<java.util.UUID, java.util.UUID, java.util.UUID, java.lang.Object, java.sql.Timestamp> fieldsRow() {
	 ...
	 */
	@Override
	public org.jooq.Row5<java.util.UUID, java.util.UUID, java.util.UUID, java.lang.Object, java.sql.Timestamp> valuesRow() {
	...
	public org.jooq.Field<java.util.UUID> field1() {
		return com.quizzes.api.common.model.tables.ContextProfileEvent.CONTEXT_PROFILE_EVENT.ID;
	}
	...
	public org.jooq.Field<java.util.UUID> field2() {
		return com.quizzes.api.common.model.tables.ContextProfileEvent.CONTEXT_PROFILE_EVENT.CONTEXT_PROFILE_ID;
	}
	...
	public org.jooq.Field<java.util.UUID> field3() {
		return com.quizzes.api.common.model.tables.ContextProfileEvent.CONTEXT_PROFILE_EVENT.RESOURCE_ID;
	}
	...
	public org.jooq.Field<java.lang.Object> field4() {
		return com.quizzes.api.common.model.tables.ContextProfileEvent.CONTEXT_PROFILE_EVENT.EVENT_DATA;
	}
	...
	public org.jooq.Field<java.sql.Timestamp> field5() {
		return com.quizzes.api.common.model.tables.ContextProfileEvent.CONTEXT_PROFILE_EVENT.CREATED_AT;
	}
	 ...
	 */
	@Override
	public ContextProfileEventRecord value4(java.lang.Object value) {
		setEventData(value);
		return this;
	}
	 ...
	 */
	@Override
	public ContextProfileEventRecord values(java.util.UUID value1, java.util.UUID value2, java.util.UUID value3, java.lang.Object value4, java.sql.Timestamp value5) {
		return this;
	}
	...
	public ContextProfileEventRecord() {
		super(com.quizzes.api.common.model.tables.ContextProfileEvent.CONTEXT_PROFILE_EVENT);
	}

	/**
	 * Create a detached, initialised ContextProfileEventRecord
	 */
	public ContextProfileEventRecord(java.util.UUID id, java.util.UUID contextProfileId, java.util.UUID resourceId, java.lang.Object eventData, java.sql.Timestamp createdAt) {
		super(com.quizzes.api.common.model.tables.ContextProfileEvent.CONTEXT_PROFILE_EVENT);
