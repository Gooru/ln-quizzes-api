...
public class ContextProfileRecord extends org.jooq.impl.TableRecordImpl<com.quizzes.api.core.model.jooq.tables.records.ContextProfileRecord> implements org.jooq.Record8<java.util.UUID, java.util.UUID, java.util.UUID, java.util.UUID, java.lang.Boolean, java.sql.Timestamp, java.sql.Timestamp, java.lang.String> {

	private static final long serialVersionUID = 1916236597;
	 ...
	 */
	@Override
	public org.jooq.Row8<java.util.UUID, java.util.UUID, java.util.UUID, java.util.UUID, java.lang.Boolean, java.sql.Timestamp, java.sql.Timestamp, java.lang.String> fieldsRow() {
	 ...
	 */
	@Override
	public org.jooq.Row8<java.util.UUID, java.util.UUID, java.util.UUID, java.util.UUID, java.lang.Boolean, java.sql.Timestamp, java.sql.Timestamp, java.lang.String> valuesRow() {
	 ...
	 */
	@Override
	public ContextProfileRecord value8(java.lang.String value) {
	 ...
	 */
	@Override
	public ContextProfileRecord values(java.util.UUID value1, java.util.UUID value2, java.util.UUID value3, java.util.UUID value4, java.lang.Boolean value5, java.sql.Timestamp value6, java.sql.Timestamp value7, java.lang.String value8) {
		return this;
	}
	 ...
	 */
	public ContextProfileRecord(java.util.UUID id, java.util.UUID contextId, java.util.UUID profileId, java.util.UUID currentResourceId, java.lang.Boolean isComplete, java.sql.Timestamp createdAt, java.sql.Timestamp updatedAt, java.lang.String eventSummaryData) {
		super(com.quizzes.api.core.model.jooq.tables.ContextProfile.CONTEXT_PROFILE);
