...
public class EventCollection extends EventCommon {
    ...
    @Builder
    public EventCollection(UUID eventId, String eventName, Session session, User user, Version version, Map metrics,
                           String timezone, long startTime, Long endTime, ContextCollection context,
